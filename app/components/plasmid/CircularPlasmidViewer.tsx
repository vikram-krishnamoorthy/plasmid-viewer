...
} from './CircularPlasmidAnnotations';
...
export const CircularPlasmidViewer: React.FC<CircularPlasmidViewerProps> = ({
  ...
  const [hoveredFeatureDetails, setHoveredFeatureDetails] = useState<LabelPosition | undefined>(
    undefined
  );
  ...
  return (
    <div className="relative flex-1 bg-white">
      ...
      >
        ...
        {selectedRegion && <SelectionHighlight selectionPath={getSelectionPath()} />}
